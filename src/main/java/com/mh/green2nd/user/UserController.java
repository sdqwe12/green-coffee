...
public class UserController {
    ...
    @Operation(summary = "회원가입",description = "회원가입할 때 입력값은 email = 이메일 형식 맞춰해야함, password = 영문자 숫자 하나씩은 필수 특수문자도 들어가고 6자 이상, nickname = 중복 가능, phone = 숫자11자리, birthdate = 숫자6자리  ")
    @ApiResponses({
